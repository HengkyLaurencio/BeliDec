                ...
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    ...
                    <div class="flex">
                        ...
                        <form method="post" action="{{ route('putItem', ['cart_id' => $product->cart_id, 'product_id' => $product->id]) }}">
                            @csrf
                            @method('POST')
                            <input type="number" name="quantity" id="quantity" min="1" value="1" class="border rounded px-2 py-1 ml-28 w-16 text-center focus:outline-none focus:border-blue-500">
