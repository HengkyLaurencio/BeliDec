                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    ...
                    <div class="flex flex-col space-y-4 mt-4">
                        ...
                        @foreach ($cartItemsData as $item)
                            <div
                                class="grid grid-cols-6 gap-4 items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
                                <div class="col-span-2 flex items-center">
                                    <div class="dark:text-gray-300">
                                        <h2 class="text-lg font-semibold dark:text-gray-300">{{ $item->product->name }}
                                        </h2>
                                    </div>
                                </div>
                    ...
                    <div class="flex justify-between items-center mt-6">
                        <a href="#" class="text-gray-700 dark:text-gray-200 hover:underline">&larr; Back to
                            shopping</a>
